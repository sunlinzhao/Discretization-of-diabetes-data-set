...
data = pd.read_csv(r'D:\PyCharm 2020.1.1\project\roughset\dataset\archive\diabetes.csv', header=0,
                   encoding='utf-8')
# 选取数据
select_col = ['Pregnancies', 'Glucose', 'BloodPressure', 'SkinThickness', 'Insulin', 'BMI', 'DiabetesPedigreeFunction', 'Age',
              'Outcome']
...
# 划分训练集 为了数据均衡 分层抽样
df_train, df_test = train_test_split(data, test_size=0.2, stratify=data['Outcome'])
